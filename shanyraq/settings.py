...
SECRET_KEY = 'django-insecure-wht38t=7l&vpr^7si5n!%h%n-p6cyi#ca21%vo4_ivtck&e*bl'
...
WSGI_APPLICATION = 'shanyraq.wsgi.application'
...
# Email settings (django email server is used instead of real email service)
